...
abstract class CRM_Committees_Plugin_Importer extends CRM_Committees_Plugin_Base {
   ...
   *
   * @param \Civi\Committees\CommitteeModuleSurvey $importer_survey
   *
   * @return void
   */
   ...
   */
  abstract public function probeFile($file_path) : bool;
   ...
   */
  abstract public function importModel($file_path) : bool;
