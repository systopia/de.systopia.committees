 ...
 */
class CRM_Committees_Implementation_OxfamSimpleImporter extends CRM_Committees_Plugin_Syncer
{
    ...
    {
        return E::ts("Kürschner/Oxfam Simple Import (CSV)");
    }

    public function getDescription(): string
    {
        return E::ts("Kürschner Bundestag Data - Oxfam Model - one-shot");
    }
