...
// Make CRM_Committees_ExtensionUtil available.
require_once __DIR__ . '/../../committees.civix.php';
...
addExtensionToClassLoader('de.systopia.committees');
 ...
 */
function _committees_test_civicrm_container(ContainerBuilder $container): void {
}
